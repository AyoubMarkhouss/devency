          ...
          <div className="relative grid  w-full grid-cols-1 gap-8 lg:max-w-2xl xl:gap-7 md:grid-cols-2">
            ...
            >
              <div className="flex md:flex-col items-center md:items-start">
                ...
                <h1 className="text-xl pl-3 sm:pl-0 md:pt-2 font-semibold text-gray-700 capitalize dark:text-white">
            ...
            <div
              ref={ref}
              className="card2  shadow-2xl backdrop-blur-xl from-darkviolet bg-gradient-to-bl to-lightviolet p-4 rounded-2xl transition hover:-translate-y-3  duration-300 ease-in-out "
            >
              <div className="flex md:flex-col items-center md:items-start pb-2 sm:pb-0">
                <span className="inline-block p-3 text-lightviolet bg-blue-100 rounded-xl">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6"
                ...
                <h1 className="text-xl pl-3 sm:pl-0 md:py-2 font-semibold text-gray-700 capitalize dark:text-white">
                  Expertise Libérée
                </h1>
              </div>
              <p className="text-gray-500 dark:text-gray-300">
                Libérez la maîtrise numérique avec Devency. Nos experts
                industriels créent des solutions innovantes adaptées à vos
                besoins spécifiques.
              </p>
            </div>
            ...
            <div
              ref={ref}
              className="card3 shadow-2xl backdrop-blur-xl from-darkviolet bg-gradient-to-bl to-lightviolet p-4 rounded-2xl transition hover:-translate-y-3  duration-300 ease-in-out "
            >
              <div className="flex md:flex-col items-center md:items-start pb-2 sm:pb-0">
                <span className="inline-block p-3 text-lightviolet bg-blue-100 rounded-xl ">
                  <svg
                ...
                <h1 className="text-xl md:py-2 pl-3 sm:pl-0 font-semibold text-gray-700 capitalize dark:text-white">
                  Brillance Collaborative
                </h1>
              </div>
              <p className="text-gray-500 dark:text-gray-300">
                Notre approche collaborative assure l&apos;alignement de vos
                objectifs, encourage une communication transparente et dépasse
                les attentes.
              </p>
            </div>
            ...
            >
              <div className="flex md:flex-col items-center md:items-start">
                ...
                <h1 className="text-xl md:pt-2 pl-3 sm:pl-0 font-semibold text-gray-700 capitalize dark:text-white">
                  Qualité supérieure
                </h1>
              </div>
              <p className="text-gray-500 dark:text-gray-300">
